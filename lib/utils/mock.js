...
const random_range = (items) => { return items[random(0, items.length - 1)] };
...
module.exports = {
  ...
  image_url: () => { return "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Walnut.png/30px-Walnut.png" },
  url: () => { return 'http://lalalalalalalalalalalalalalalalalala.com/' },
  random_range: random_range,
  boolean: () => { return random_range([true, false]); }
}
